...
if [ ${MODE} = "controller" -o ${MODE} = "con" ]; then
    ...
    ip route add fc00:1::1/128 encap seg6local action End dev ${ETH}
    ...
    ip route add fc00:2::1/128 encap seg6local action End dev ${ETH}
    ...
    ip route add fc00:3::1/128 encap seg6local action End dev ${ETH}
    ...
    ip route add fc00:4::1/128 encap seg6local action End dev ${ETH}
    ...
    ip route add fc00:4::/64 encap seg6 mode encap segs fc00:2::1 dev ${ETH} table 100
    ip route add fc00:4::/64 encap seg6 mode encap segs fc00:3::1 dev ${ETH} table 101
    ip route add fc00:4::/64 encap seg6 mode encap segs fc00:2::1,fc00:3::1 dev ${ETH} table 102
