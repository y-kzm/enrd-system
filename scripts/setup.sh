...
if [ ${MODE} = "controller" -o ${MODE} = "con" ]; then
    ...
    ip route add fc00:4::/64 encap seg6 mode encap segs fc00:2::0 dev ${ETH} table 100
    ip route add fc00:4::/64 encap seg6 mode encap segs fc00:3::0 dev ${ETH} table 101
    ip route add fc00:4::/64 encap seg6 mode encap segs fc00:2::0,fc00:3:: dev ${ETH} table 102
