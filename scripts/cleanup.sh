...
if [ ${MODE} = "compute1" -o ${MODE} = "com1" ]; then
        ...
        ip -6 route del fc00:4::/64 encap seg6 mode encap segs fc00:2:: dev ${ETH} table 100 metric 1024 pref medium
        ip -6 route del fc00:4::/64 encap seg6 mode encap segs fc00:3:: dev ${ETH} table 101 metric 1024 pref medium
        ip -6 route del fc00:4::/64 encap seg6 mode encap segs fc00:2::,fc00:3:: dev ${ETH} table 102 metric 1024 pref medium
        ...
        ip route del fc00:1:: encap seg6local action End dev ${ETH} metric 1024 pref medium
